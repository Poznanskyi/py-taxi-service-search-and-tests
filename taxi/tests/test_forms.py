...
class ManufacturerSearchFormTests(TestCase):
    def setUp(self):
        ...
        Manufacturer.objects.create(name="BMV", country="test")
        Manufacturer.objects.create(name="AUDI", country="test")
...
class CarSearchFormTests(TestCase):
    def setUp(self):
        ...
        Car.objects.create(model="qwe223", manufacturer=self.manufacturer)
    ...
    def test_form_valid_data(self):
        ...
        self.assertNotIn("qwe223", [car.model for car in cars])
